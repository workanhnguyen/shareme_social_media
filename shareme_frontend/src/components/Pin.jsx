...
const Pin = ({ pin: { postedBy, imgUrl, _id, destination, save }}) => {
  ...
  return (
    <div className='m-2'>
      ...
      >
        <img className='rounded-lg w-full' src={urlFor(imgUrl).width(250).url()} alt="user-post" />
        {postHovered && (
          <div 
